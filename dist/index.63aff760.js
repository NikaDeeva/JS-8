...
console.log("Students data:", (0, _dataJsonDefault.default));
...
const filterByName = (query)=>{
    const filtered = (0, _dataJsonDefault.default).filter((student)=>student.name.toLowerCase().includes(query.toLowerCase()));
    showStudents(filtered);
};
const filterBySurname = (query)=>{
    const filtered = (0, _dataJsonDefault.default).filter((student)=>student.surname.toLowerCase().includes(query.toLowerCase()));
    showStudents(filtered);
};
const filterBySection = (query)=>{
    const filtered = (0, _dataJsonDefault.default).filter((student)=>student.section.toLowerCase().includes(query.toLowerCase()));
    showStudents(filtered);
};
